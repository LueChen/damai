...
function qiang() {
    ...
    var performid = firstperform.getAttribute('data-performid');
    ...
    for (var i = 0; i < children.length; i++) {
      // if match the price u want.
      if (children[i].getAttribute('data-price') == price) {
          priceid = children[i].getAttribute('data-priceid');
